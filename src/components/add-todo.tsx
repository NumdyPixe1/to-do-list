    ...
    return (<>
        <div className="todo-container ">
            <form className="flex space-x-4" onSubmit={handleSubmit(onSubmit)}>
                ...
                <button type="submit" className="px-6 py-2 bg-blue-500 text-white font-semibold rounded-lg hover:bg-blue-600 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:ring-offset-2 transition duration-300 ease-in-out cursor-pointer">Add</button>
                {errors.todoName && <ErrorModal errorText="This field is required" />}
            </form>
            {/* <div className=" bg-red-200 p-2 text-red-500 border-solid">This field is required</div> */}
        </div >
    </>)
}
